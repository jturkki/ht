 ...
 * @version 2022.08.09 15:10:01 // Generated by ComTest
 *
 */
...
public class HetuTarkistusTest {
  ...
  public void testTarkista28() {    // HetuTarkistus: 28
    ...
    assertEquals("From: HetuTarkistus line: 35", "Liian pieni pivmr", hetut.tarkista("001212")); 
    assertEquals("From: HetuTarkistus line: 36", "Liian suuri pivmr", hetut.tarkista("321212")); 
    assertEquals("From: HetuTarkistus line: 37", "Liian suuri pivmr", hetut.tarkista("300212")); 
    assertEquals("From: HetuTarkistus line: 38", "Liian suuri pivmr", hetut.tarkista("310412")); 
    ...
    assertEquals("From: HetuTarkistus line: 42", "Yksilosassa kirjaimia", hetut.tarkista("121212-2k2Q")); 
    assertEquals("From: HetuTarkistus line: 43", "Yksilosa liian lyhyt", hetut.tarkista("121212-2")); 
    assertEquals("From: HetuTarkistus line: 44", "Yksilosa liian lyhyt", hetut.tarkista("121212-")); 
    assertEquals("From: HetuTarkistus line: 45", "Hetu liian pitk", hetut.tarkista("121212-12345")); 
